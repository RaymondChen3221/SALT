(function () {
  ...
  const main = [
    ...
    { id: "s_self_3", section: "main", axis: "S", axisLabel: "特殊性", perspective: "self", perspectiveLabel: "我会给出", pair: "S3", direction: -1, text: "即使很喜欢对方，我也不太愿意频繁牺牲独处、休息、工作或爱好的时间。" },
    ...
    { id: "s_self_6", section: "main", axis: "S", axisLabel: "特殊性", perspective: "self", perspectiveLabel: "我会给出", pair: "S6", direction: -1, text: "对我来说，和喜欢的人相处不一定要明显高于和朋友相处的优先级。" },
    ...
    { id: "s_other_3", section: "main", axis: "S", axisLabel: "特殊性", perspective: "other", perspectiveLabel: "我期待对方", pair: "S3", direction: -1, text: "即使我需要关心，我也不希望TA经常放下手中一切事务来回应我。" },
    { id: "s_other_4", section: "main", axis: "S", axisLabel: "特殊性", perspective: "other", perspectiveLabel: "我期待对方", pair: "S4", direction: -1, text: "我不太需要对方主动察觉我的吃醋或占有欲。" },
    ...
    { id: "a_other_3", section: "main", axis: "A", axisLabel: "兑现力", perspective: "other", perspectiveLabel: "我期待对方", pair: "A3", direction: -1, text: "我的情绪上能够接受对方偶尔冷处理、拒绝解释一些问题。" },
    ...
    { id: "l_self_2", section: "main", axis: "L", axisLabel: "长程性", perspective: "self", perspectiveLabel: "我会给出", pair: "L2", direction: -1, text: "即使喜欢一个人，我也不太会具体想象和TA一起生活的点点滴滴。" },
    { id: "l_self_3", section: "main", axis: "L", axisLabel: "长程性", perspective: "self", perspectiveLabel: "我会给出", pair: "L3", direction: -1, text: "当下的感觉，氛围和冲动相比起以后日常相处会不会起冲突更重要。" },
    ...
    { id: "l_other_6", section: "main", axis: "L", axisLabel: "长程性", perspective: "other", perspectiveLabel: "我期待对方", pair: "L6", direction: 1, text: "在人生的节点，比如毕业典礼，我会很期待对方出现。" }
  ];
  ...
  const support = [
    ...
    { id: "support_practical_2", section: "support", support: "practical", supportLabel: "实用托底", perspective: null, pair: "P2", direction: -1, text: "遇到个人的现实问题的时候，我更宁愿自己解决而不是依赖对方。" },
    ...
    { id: "support_creative_2", section: "support", support: "creative", supportLabel: "共同创作", perspective: null, pair: "C2", direction: -1, text: "即使对方不参与我的兴趣或创作，只要理解和支持我就够了。" },
    ...
    { id: "support_presence_2", section: "support", support: "presence", supportLabel: "低压在场", perspective: null, pair: "N2", direction: -1, text: "我不太需要对方秒回，回应质量比随时在线更重要。" }
  ];
